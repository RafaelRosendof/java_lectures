/*
 * Criação de um script em Java que calcula uma integral numérica usando o método do trapézio.
 * A difereça é que o script irá usar programação paralela para calcular a integral.
 * Fazendo assim uma enorme diferença na velocidade de cálculo
 */
